...
public class MatrixPanel extends JPanel
{
	...
	public MatrixPanel()
	{
		...
		// initialize the nodes with a random set of integers 0 ..
		// MAX_RANDOM_NUMBER
	 ...
	 *            the column.
	 * @param color
	 *            the color to set node[row][]column] to.
	 */
	...
	/**
	 * reset the values of the buttons to original colors and new random values.
	 */
